...
from utils.dataset_InferSent import get_nli, get_batch, build_vocab
from utils.mutils import get_optimizer
from baseline.InferSent import NLINet

parser = argparse.ArgumentParser(description='NLI training')
# paths
parser.add_argument("--nlipath", type=str, default='data/train-test_data/', help="NLI data path (SNLI or MultiNLI)")
parser.add_argument("--outputdir", type=str, default='checkpoint/Infer', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='model.pickle')
parser.add_argument("--word_emb_path", type=str, default="data/embedding/Tencent_AILab_ChineseEmbedding.txt", help="word embedding file path")
